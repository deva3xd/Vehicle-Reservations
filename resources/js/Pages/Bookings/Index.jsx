  ...
  return (
    <PageLayout title="Bookings">
      ...
      <div className="flex justify-between items-center my-2">
        ...
        <Link href={route('bookings.create')} className="px-6 py-2 rounded-lg cursor-pointer text-white text-className tracking-wider font-medium border-0 outline-0 outline-none bg-blue-700 hover:bg-blue-800 active:bg-blue-700">Add Data</Link>
      </div>
              ...
              <tr key={i}>
                ...
                <td className="p-4">
                  <div className="flex items-center">
                    <Link href={route('bookings.edit', b.id)} className="mr-3 cursor-pointer">
                    ...
                    <button onClick={() => router.delete(route('bookings.destroy', b.id))} className="mr-3 cursor-pointer">
