...
const Edit = ({ booking, vehicles, drivers }) => {
  ...
  return (
    <PageLayout title="Bookings - Edit">
      ...
      <div className="flex justify-between items-center my-2">
        ...
        <Link href={route('bookings')} className="px-6 py-2 rounded-lg cursor-pointer text-white text-className tracking-wider font-medium border-0 outline-0 outline-none bg-red-700 hover:bg-red-800 active:bg-red-700">Back</Link>
      </div>
